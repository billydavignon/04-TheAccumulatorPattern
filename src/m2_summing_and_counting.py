...
def run_test_sum_more_cosines():
    ...
    # Test 2:
    expected = math.cos(-4) + math.cos(-3) + math.cos(-2) + math.cos(-1) + math.cos(0) + math.cos(1)
    answer = sum_more_cosines(-4, 1)
    print('Test 2 expected:', round(expected, 5), '(approximately)')
    if answer is not None:
        print('       actual:  ', round(answer, 5))
    else:
        print('       actual:  ', answer)
    ...
    print('Test 3 expected:', round(expected, 5), '(approximately)')
    if answer is not None:
        print('       actual:  ', round(answer, 5))
    else:
        print('       actual:  ', answer)
